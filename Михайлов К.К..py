...
"""
Делал все в соответвии с логикой и примером,
но возникают следующие ошибки по непонятным мне причинам и, валится doctest:

NameError: name 'track' is not defined. Did you mean: 'Track'?
TypeError: Garage() takes no arguments
TypeError: Borsch() takes no arguments
"""
